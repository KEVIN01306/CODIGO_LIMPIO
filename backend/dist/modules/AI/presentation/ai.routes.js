...
aiRoutes.post('/submissions/:submissionId/chat', authMiddleware.checkPermission(['assessments:read']), validatedMiddleware.validateBody(aiChatSchema), controller.chat);
