...
export class GradeAssessmentUseCase {
    ...
    async execute(input) {
        ...
        try {
            ...
            throw new AppError('AI grading service unavailable or failed to respond', 'AI_GRADING_FAILED', 502);
        }
        ...
        if (parsed.totalScore === null || parsed.totalScore === undefined || isNaN(Number(parsed.totalScore))) {
            throw new AppError(`AI grading produced an invalid or non-numeric score: "${parsed.totalScore}"`, 'AI_GRADING_FAILED', 502);
        }
        ...
        if (!parsed.aiFeedback || typeof parsed.aiFeedback !== 'string' || !parsed.aiFeedback.trim()) {
            throw new AppError('AI grading did not return valid non-empty evaluation feedback', 'AI_GRADING_FAILED', 502);
        }
        return {
...
//# sourceMappingURL=grade-assessment.usecase.js.map