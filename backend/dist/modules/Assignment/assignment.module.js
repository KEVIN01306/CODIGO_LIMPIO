...
export const courseOfferingController = new CourseOfferingController(createCourseOfferingUseCase, updateCourseOfferingUseCase, listCourseOfferingsUseCase, getCourseOfferingUseCase, deleteCourseOfferingUseCase);
export const courseEnrollmentController = new CourseEnrollmentController(createCourseEnrollmentUseCase, updateCourseEnrollmentUseCase, listCourseEnrollmentsUseCase, getCourseEnrollmentUseCase, deleteCourseEnrollmentUseCase);
