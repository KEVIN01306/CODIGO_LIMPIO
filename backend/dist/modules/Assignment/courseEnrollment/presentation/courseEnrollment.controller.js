...
export class CourseEnrollmentController extends BaseController {
    ...
    list = async (req, res, next) => {
        try {
            ...
            return res.status(200).json(ResponseHttp.pagination('CourseEnrollments retrieved successfully', result.data, result.total, limit, offset));
        }
        catch (error) {
            next(error);
        }
...
//# sourceMappingURL=courseEnrollment.controller.js.map