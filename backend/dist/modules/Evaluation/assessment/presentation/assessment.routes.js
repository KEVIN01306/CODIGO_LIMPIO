...
const controller = new AssessmentController(createUseCase, updateUseCase, getUseCase, listUseCase, deleteUseCase);
const router = Router();
const validatedMiddleware = new ValidatedMiddleware();
const authMiddleware = new AuthMiddleware();
router.use(authMiddleware.routeProtect);
router.post("/", authMiddleware.checkPermission(["assessments:create"]), validatedMiddleware.validateBody(createAssessmentSchema), controller.create);
...
router.put("/:id", authMiddleware.checkPermission(["assessments:update"]), validatedMiddleware.validateBody(updateAssessmentSchema), controller.update);
