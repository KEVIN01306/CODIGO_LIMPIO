...
export declare class AssessmentController extends BaseController {
    ...
    constructor(createUseCase: CreateAssessmentUseCase, updateUseCase: UpdateAssessmentUseCase, getUseCase: GetAssessmentUseCase, listUseCase: ListAssessmentsUseCase, deleteUseCase: DeleteAssessmentUseCase);
