...
export const usersController = new UsersController(createUserUseCase, updateUserUseCase, listUsersUseCase, disableUserUseCase, deleteUserUseCase, hashProvider);
