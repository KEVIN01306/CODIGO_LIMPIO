...
export const updateSebConfigUseCase = new UpdateSebConfigUseCase(tenantRepository, createAuditLogUseCase);
export const tenantController = new TenantController(getTenantConfigurationUseCase, updateTenantConfigurationUseCase);
export const sebConfigController = new SebConfigController(getSebConfigUseCase, updateSebConfigUseCase);
