...
const controller = new TeachersController(
    new CreateTeacherUseCase(hashProvider, createAuditLogUseCase),
    new UpdateTeacherUseCase(repository, createAuditLogUseCase),
    new ListTeachersUseCase(repository),
    new GetTeacherUseCase(repository),
    new DeleteTeacherUseCase(repository, createAuditLogUseCase)
);
